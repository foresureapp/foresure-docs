# <span class="sidebar-icon" style="--icon: url('/icons/ic--baseline-moving.svg')"></span> Roadmap
...
```mermaid
timeline
    title Foresure Development Timeline
    2024 Q1 : Concept & Design
            : Smart Contract Prototyping
    2024 Q2 : Alpha Launch on Testnet
            : Audit by Trail of Bits
    2024 Q3 : Beta Launch (Mainnet)
            : Initial Liquidity Bootstrapping
    2024 Q4 : 🚀 Public Launch
            : Mobile App Release
    2025 Q1 : DAO Governance
